        ...
        <div className="shrink-0">
          {pattern.disabled ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-gray-600/40 bg-gray-700/50 px-3 py-1.5 text-xs font-medium text-slate-400 hover:bg-gray-700 hover:text-slate-300"
            >
              View
              <ArrowRight size={12} />
            </button>
